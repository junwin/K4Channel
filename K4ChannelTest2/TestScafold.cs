...
namespace K4Channel
{
    public class TestScafold
    {
        public static void SetChannelDefinitionDefaults(List<IChannelDefinition> cds)
        {
            ...
            cds.Add(new ChannelDefinition("MSB", @"Endpoint=YOUR MSB Endpoint", 0, MQExchanges.DEFAULT, "textxyz", "K3Channel.MSBChannel"));
            cds.Add(new ChannelDefinition("MSTOPIC", @"Endpoint=YOUR MSB Endpoint", 0, MQExchanges.DEFAULT, "textzzz", "K3Channel.MSTopicChannel"));
